...
sap.ui.define([
	...
	return Controller.extend("MOBI.controller.Master", {
		...
		addDistrictDataFragment: function() {
			...
			var oModel = new sap.ui.model.json.JSONModel();
			oModel.setData(model);
			sap.ui.getCore().setModel(oModel, "DistrictCode");
		},
		...
		onChangeDistrictState1: function(Event) {
			...
			var oModel = new sap.ui.model.json.JSONModel();
			oModel.setData(property);
			OpenView.setModel(oModel, "DisrictCode");
		},
		...
		onPressSubmit_Area: function() {
			...
			var ACode = OpenView.byId("AreaCode_AreaMaster").getValue();
			var ADesc = OpenView.byId("AreaDesc_AreaMaster").getValue();
		...
		onDialogSaveButtonAreaEdit: function() {
			...
			var editDesc = sap.ui.getCore().byId("descNameAreaMasterEdit").getValue();
			var editDistrict = sap.ui.getCore().byId("districtMasterEdit").getValue();
			var editAreaStatus = sap.ui.getCore().byId("CountryCboxStatus").getValue();
		...
		onDialogSaveButtonZoneEdit: function() {
			...
			var editZoneName = sap.ui.getCore().byId("zoneNameZoneMasterEdit").getValue();
			var editArea = sap.ui.getCore().byId("areaZoneMasterEdit").getValue();
			var editZoneStatus = sap.ui.getCore().byId("CountryCboxStatus").getValue();
		...
		onPressSubmitZone: function() {
			var data = {};
			arr = [];
			data.ZONECODE = OpenView.byId("ZoneCode_ZoneMaster").getValue();
			data.ZONEDESC = OpenView.byId("ZoneDesc_ZoneMaster").getValue();
		...
		onPressSubmitBranch: function() {
			var data = {};
			arr = [];
			data.BRANCHCODE = OpenView.byId("BranchCode_BranchMaster").getValue();
			data.BRANCHDESC = OpenView.byId("Branchname_BranchMaster").getValue();
		...
		onDialogSaveButtonBranchEdit: function() {
			...
			var editBranchName = sap.ui.getCore().byId("branchNameBranchMasterEdit").getValue();
			var editZone = sap.ui.getCore().byId("zoneBranchMasterEdit").getValue();
			var editBranchStatus = sap.ui.getCore().byId("CountryCboxStatus").getValue();
		...
		onPressSubmitCountryMasterEdit: function() {
			...
			var editCountryStatus = sap.ui.getCore().byId("CountryCboxStatus").getValue();
		...
		onPressSubmitRegionMasterEdit: function() {
			...
			var editRegionStatus = sap.ui.getCore().byId("CountryCboxStatus").getValue();
		...
		onPressSubmitStateMasterEdit: function() {
			...
			var editStateStatus = sap.ui.getCore().byId("CountryCboxStatus").getValue();
